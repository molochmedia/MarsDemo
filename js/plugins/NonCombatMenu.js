 ...
 *
 * @param Menu Order
 * @desc Format is "Name: keyword". Keywords: item equip status formation save load options toTitle cancel quest
 ...
 * @help 
 * ----------------------------------------------------------------------------
 *   Non-Combat Menu v1.01 by mjshi
 ...
 *
 * > Update v1.01a
 * - Made it so backgrounds actually work and didn't error xD
 *
...
Scene_NCMenu.prototype.createCommandWindow = function() {
    ...
    for (var i = 0; i < NCMenu.menuList.length; i++) {
      ...
      this._commandWindow.setHandler(method, eval(String("this.command" + method.charAt(0).toUpperCase() + method.slice(1) + ".bind(this)")));
    }
